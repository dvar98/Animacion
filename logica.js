...
const graphData = {
    nodes: [
        ...
        { id: 2, name: "Contenedor 1", state: "undefined", x: 146, y: 256 },
        { id: 3, name: "Contenedor 2", state: "undefined", x: 289, y: 150 },
        { id: 4, name: "Contenedor 3", state: "undefined", x: 310, y: 257 },
        { id: 5, name: "Contenedor 4", state: "undefined", x: 296, y: 388 },
    ],
    links: [
    ]
};
...
const nodeLabels = svg.selectAll(".node-label")
    ...
    .text(d => d.name !== "Base de Carga" ? `${d.name}` : d.name)
    .attr("dx", -50)
    .attr("dy", 25);
